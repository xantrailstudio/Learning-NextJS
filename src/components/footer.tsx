        ...
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          <Link className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <svg
              ...
              fill="none"
              stroke="currentColor"
              strokeLinecap="round" // Fixed: stroke-linecap -> strokeLinecap
              strokeLinejoin="round" // Fixed: stroke-linejoin -> strokeLinejoin
              strokeWidth="2" // Fixed: stroke-width -> strokeWidth
